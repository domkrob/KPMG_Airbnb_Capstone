# Team Work Plan — Urban Rental Intelligence Copilot

Sequential split of the remaining capstone work, mapped to both the KPMG slide flow and the handover phases.

| # | Owner | Role | Phase | KPMG step | Status |
|---|---|---|---|---|---|
...
**Working principle:** the 7 canonical questions in the handover are the anchor. If a feature, model, or chatbot tool doesn't serve one of those questions, it doesn't belong in the MVP.
